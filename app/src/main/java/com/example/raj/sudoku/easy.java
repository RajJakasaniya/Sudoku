        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(i==1) {
                    ...
                    i++;
                        AlertDialog alert = new AlertDialog.Builder(easy.this).create();
    ...
    public void creategrid(int i){
        switch (i){
            case 1:
                ...
                t04.setText("8");
                t04.setTextColor(Color.BLACK);
                t04.setEnabled(false);
                t05.setText("6");
                t05.setTextColor(Color.BLACK);
            ...
            case 2:
                ...
                t52.setText("5");
                t52.setTextColor(Color.BLACK);
                t52.setEnabled(false);
                t54.setText("6");
                t54.setTextColor(Color.BLACK);
                t54.setEnabled(false);
                t55.setText("7");
                t55.setTextColor(Color.BLACK);
                t55.setEnabled(false);
                t56.setText("9");
                t56.setTextColor(Color.BLACK);
